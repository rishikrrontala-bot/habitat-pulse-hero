 ...
 * The mediaType-reset effect below resets scrub state when a consumer
 * toggles mediaType on an already-mounted instance (e.g. a video/image
 * switcher) rather than remounting. Not exercised by this integration
 * (mediaType is passed once, never toggled), kept for parity with the
 * component as given rather than restructured. */
        ...
        <div className='relative w-full flex flex-col items-center min-h-[100dvh]'>
          ...
          <div className='container mx-auto flex flex-col items-center justify-start relative z-10'>
            <div className='flex flex-col items-center justify-center w-full h-[100dvh] relative'>
              ...
              >
                <motion.h2
                  className='text-4xl md:text-5xl lg:text-6xl font-bold text-emerald-200 transition-none'
                  style={{ transform: `translateX(-${textTranslateX}vw)` }}
                >
                  {firstWord}
                </motion.h2>
                <motion.h2
                  className='text-4xl md:text-5xl lg:text-6xl font-bold text-center text-emerald-200 transition-none'
                  style={{ transform: `translateX(${textTranslateX}vw)` }}
                >
                  {restOfTitle}
                </motion.h2>
